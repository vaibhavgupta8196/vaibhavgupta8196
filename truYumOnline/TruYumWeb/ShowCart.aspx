<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowCart.aspx.cs" Inherits="TruYumWeb.ShowCart" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        Cart</h><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="lblDelete" runat="server" ForeColor="#00CC00" Text="Label" Visible="False"></asp:Label>
        <br>
